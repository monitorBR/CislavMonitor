    ...
    <div className="mx-auto grid max-w-7xl gap-5 px-4 py-5 lg:grid-cols-[280px_1fr]">
      ...
      <section className="space-y-5">
        ...
        <Card title="Repasses municipais" icon={<Banknote size={18}/>}>
          ...
          <div className="mb-3 rounded-md border border-emerald-200 bg-emerald-50 p-3 text-sm text-emerald-950">Carrancas: a receita do CISLAV registra R$ 225.225,56 em maio, com R$ 4.151,48 em rateio no dia 15/05 e R$ 221.074,08 em programa no dia 29/05. A API municipal por nome completo também retorna R$ 225.225,56 em quatro linhas, incluindo uma parcela de rateio de R$ 633,93 que pode não aparecer em filtros visuais mais restritos do portal.</div>
